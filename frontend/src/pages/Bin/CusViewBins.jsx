...
import { Input, Button, Table, Popconfirm } from 'antd'; // Added Popconfirm for confirmation before deletion
import { SearchOutlined, EyeOutlined, DeleteOutlined, EditOutlined, FilePdfOutlined } from '@ant-design/icons';
            ...
            {loading ? (
                ...
                <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                        ...
                        <div>
                            <Button className='btn-pay' onClick={() => exportPDF()} icon={<FilePdfOutlined />}>Generate PDF</Button>
                        </div>
